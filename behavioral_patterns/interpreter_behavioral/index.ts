...
context.put("c",3);
context.put("d",4);
console.log(new BinaryNonTermainlExpression(new BinaryNonTermainlExpression(new TerminalExpression("a"),new TerminalExpression("b"),'+'),
                                            new BinaryNonTermainlExpression(new TerminalExpression("c"),new TerminalExpression("d"),'+'),
                                            '*').interpret(context));
